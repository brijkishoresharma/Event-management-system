...
public class CreateEvent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 34, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Type of Event ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 90, 175, 38));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Venue");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 140, 160, 38));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Date");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 193, 160, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Duration");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 243, 175, -1));
        ...
        getContentPane().add(ntf, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 28, 211, 38));
        getContentPane().add(ttf, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 90, 211, 38));
        getContentPane().add(vtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 140, 211, 38));
        getContentPane().add(dtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 187, 211, 38));
        getContentPane().add(durtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 237, 211, 38));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 306, 121, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(473, 306, 150, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(272, 306, 137, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String type=ttf.getText();
        String venue= vtf.getText();
        String date = dtf.getText();
        String duration = durtf.getText();
        try{
        connectionclass obj = new connectionclass();
        String q= "insert into events(name,type_of_event,venue,date,duration) values('"+name+"','"+type+"','"+venue+"','"+date+"','"+duration+"')";
